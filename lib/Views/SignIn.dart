...
import 'package:chatmate/Views/SignUp.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                    color: ThemeColors.receiverColor,
                    borderRadius: BorderRadius.only(topRight: Radius.circular(52),topLeft: Radius.circular(52))
                  ),
              child: Form(
                key: _formKey,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: Decorations.textBoxDecorations(context,"Username","wamiq123"),
                      ),
                      SizedBox(
                        height: 15,
                      ),
                      ...
                      ElevatedButton(
                          ...
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>ChatRoom()));
                          },
                          child: Container(
                              width: MediaQuery.of(context).size.width,
                              child: Center(
