  ...
  Future signUp() async {
    ...
    if (formState!.validate()) {
      if(results==ConnectivityResult.none){
        ...
        try {
          Users users = new Users(name: usernameController.text,number: numberController.text,password: passwordController.text,
              email: emailController.text, profilePicture: '', uId: '');
          await Future.wait([
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  ...
                  content: e == "The email address is badly formatted."
                      ...
                      :e=="An internal error has occurred. [ 7: ]"? Text("No Internet"): Text("Invalid email or password"),
                  actions: <Widget>[
                    TextButton(
                      child: Text("Try Again!"),
                      onPressed: () {
            ...
            child: Column(
              children: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundColor: Colors.transparent,//File(_imageFileList![index].path)
                        child: _image!=null?Image.file(_image,fit: BoxFit.fill,):Image.asset("Assets/noprofilepic.png"),
                      ),
                      // SpeedDial(
                      ...
                      CircleAvatar(
                        radius: MediaQuery.of(context).size.width/18,
                          ...
                          child: IconButton(icon: Icon(Icons.camera_alt),color: Colors.white, onPressed: () { getImagefromGallery(); },)
                      )
                    ],
                  ),
                ),
                ...
                TextFormField(
                  ...
                  decoration: Decorations.textBoxDecorations(context,"Display name","")
                ),
                SizedBox(
                  height: 20,
                ),
                TextFormField(
                  ...
                  controller: numberController,
                    ...
                    decoration: Decorations.textBoxDecorations(context,"Number","")
                ),
                SizedBox(
                  height: 20,
                ),
                TextFormField(
                  ...
                  controller: emailController,
                    ...
                    decoration: Decorations.textBoxDecorations(context,"Email","abc@gmail.com")
                ),
                SizedBox(
                  height: 20,
                ),
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: InkWell(
                      child: _isHidden? Icon(Icons.visibility,color: ThemeColors.secondaryColor,size: 18):Icon(Icons.visibility_off,color: ThemeColors.secondaryColor,size: 18),
